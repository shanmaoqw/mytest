...
/**
 * 文件名： com.bozhon.utils.string.StringUtil.java
 * 作者：   WenBin
 * 日期：   2017年10月18日
 * 功能说明：
 * =========================================================
...
public class StringUtil {
	...
	/**
	 * @Method: com.bozhon.utils.string.StringUtil.isEmpty
	 * @Description:  空为真
	 * @author: WenBin
	 * @date: 2018年1月18日
	 * @version: 1.0
	...
	/**
	 * 格式化带参数的字符串，如 /param/detail.tl?a={0}&b={1}
	 *
	 * @param message
	 * @param args
	 * @return
     ...
     * @return
     */
    public static String join(List<String> aryStr,String separator){
        String str="";
