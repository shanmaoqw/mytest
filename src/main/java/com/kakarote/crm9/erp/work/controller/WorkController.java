...
public class WorkController extends Controller {
     ...
     */
    public void queryProjectsByCustomIdAndType(BasePageRequest<Work> basePageRequest){
        renderJson(workService.queryProjectByCustomIdAndType(basePageRequest));
    }
     ...
     * @param basePageRequest
     */
    public void queryProjectsByUserIdAndType(BasePageRequest<Work> basePageRequest){
        renderJson(workService.queryProjectsByUserIdAndType(basePageRequest));
    }
}
