...
public class _MappingKit {
	...
	public static void mapping(ActiveRecordPlugin arp) {
		...
		arp.addMapping("72crm_work_template", "id", WorkTemplate.class);
		arp.addMapping("72crm_work_document", "id", WorkDocument.class);
		arp.addMapping("72crm_work_template_document", "id", TemplateDocument.class);
		arp.addMapping("72crm_crm_enterprise", "solr_id", CrmEnterprise.class);
		arp.addMapping("72crm_crm_shareholder", "id", CrmShareHolder.class);
		arp.addMapping("72crm_crm_patent", "id", CrmPatent.class);
		arp.addMapping("72crm_crm_trademark", "id", CrmTrademark.class);
		arp.addMapping("72crm_crm_copyright", "id", CrmCopyright.class);
		arp.addMapping("72crm_crm_soft_copyright", "id", CrmSoftCopyright.class);
		arp.addMapping("72crm_task_document","id",TaskDocument.class);
		arp.addMapping("72crm_crm_tax", "tax_id", CrmTax.class);
		arp.addMapping("72crm_crm_technology_project", "project_id", CrmTechnologyProject.class);
	}
}
