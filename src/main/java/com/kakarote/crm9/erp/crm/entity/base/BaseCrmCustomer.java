...
public abstract class BaseCrmCustomer<M extends BaseCrmCustomer<M>> extends Model<M> implements IBean {
	...
	public String getSaasId(){
		return getStr("saas_id");
	}

	public void setSaasPort(Integer saasPort){
		set("saas_port",saasPort);
	}

	public Integer getSaasPort(){
		return getInt("saas_port");
	}

	public void setSaasCustomerType(Integer saasCustomerType){
		set("saas_customer_type",saasCustomerType);
	}

	public Integer getSaasCustomerType(){
		return getInt("saas_customer_type");
	}

	public void setSaasStatus(Integer saasStatus){
		set("saas_status",saasStatus);
	}

	public Integer getSaasStatus(){
		return getInt("saas_status");
	}
}
