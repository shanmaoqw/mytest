...
import com.kakarote.crm9.erp.editor.common.EditorRouter;
...
import com.kakarote.crm9.swagger.common.SwaggerRouter;
...
public class JfinalConfig extends JFinalConfig {
    ...
    public static Prop aliProp = PropKit.use("config/aliyun.txt");
    ...
    public void configRoute(Routes me) {
        ...
        me.add(new EditorRouter());
        me.add(new SwaggerRouter());
    }
    ...
    public void configPlugin(Plugins me) {
        ...
        //solr插件
        String username = prop.get("data.solr.username");
        String password = prop.get("data.solr.password");
        String host = prop.get("data.solr.host");
        me.add(new SolrPlugin(username,password,host));
        //阿里短信服务
        me.add(new AliSmsPlugin(aliProp.get("SMS_REGION_ID"),aliProp.get("ACCESS_KEY_ID"),aliProp.get("ACCESS_KEY_SECRET")));
    ...
    public void configHandler(Handlers me) {
    	//UrlSkipHandler urlSkipHandler=new UrlSkipHandler("/swagger/.*",true);
