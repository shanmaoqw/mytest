...
public class ErrorRender extends Render {
    ...
    private static String HTML_CONTENT = "<html><head><title>TITLE</title></head><body bgcolor='white'><center><h1>CONTENT</h1></center><hr>https://guanwen100.com/</body></html>";
    ...
    private String getErrorHtml() {
        ...
        if (errorCode == 404) {
            ...
            return "<html><head><title>" + errorCode + " Error</title></head><body bgcolor='white'><center><h1>" + errorCode
                    + " Error</h1></center><hr>贯文CRM</body></html>";
        }
    }
